          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-teal-300">Ancient Wisdom • Modern Healing</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center space-x-3 text-teal-200">
                ...
                <span className="text-sm">hello@ekabrahmaa.com</span>
              </div>
              <div className="flex items-center space-x-3 text-teal-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <Link href="/privacy" className="text-teal-200 hover:text-white transition-colors duration-200">
                Privacy
              </Link>
              <Link href="/terms" className="text-teal-200 hover:text-white transition-colors duration-200">
                Terms
              </Link>
              <Link href="/disclaimer" className="text-teal-200 hover:text-white transition-colors duration-200">
                Disclaimer
              </Link>
