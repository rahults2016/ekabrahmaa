  ...
  return (
    <Card className="w-full max-w-md mx-auto border-teal-200 shadow-xl bg-white/90 backdrop-blur-sm">
      <CardHeader className="text-center">
        <CardTitle className="text-2xl font-serif text-teal-900">Get Started</CardTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              className="mt-1"
            />
            <Label htmlFor="acceptTerms" className="text-sm text-teal-700 cursor-pointer">
              I agree to the{' '}
              <LoadingLink href="/terms" className="text-teal-600 hover:underline">
                Terms of Service
              </LoadingLink>{' '}
              and{' '}
              <LoadingLink href="/privacy" className="text-teal-600 hover:underline">
                Privacy Policy
              </LoadingLink>
            </Label>
          </div>
