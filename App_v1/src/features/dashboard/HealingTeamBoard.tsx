...
import { FileText, Video, ChevronDown, Award, Calendar, MapPin, Languages, Plus, ArrowRight, Star, Users, Check } from 'lucide-react';
import { Link } from 'react-router-dom';
import { detailedHealers } from '../../data/healers';
...
const healingTeam = detailedHealers.slice(0, 3).map(healer => ({
  ...
  nextAppointmentTime: new Date(Date.now() + Math.random() * 1000 * 60 * 60 * 4),
