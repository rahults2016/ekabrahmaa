...
import { Home, Calendar, User, BookOpen, FileText, MessageCircle, Activity, CreditCard, Receipt, History,
  BookOpenText, Settings, X, Upload , Heart, Bookmark, Stethoscope, ShoppingCart, 
  HelpCircle, Star, ArrowRight, CheckCircle } from 'lucide-react';
