...
import { 
  ...
  Check, CheckCheck, Users, Smile, Video, Phone, Star, Calendar, Award, BookmarkPlus, Filter, Settings,
  MapPin, Languages, Shield, Archive, Pin,
  Mic, Camera, Stethoscope, MessageSquare, Copy
} from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { type Message, type ChatHealer, mockHealers, generateMockMessages } from './chatData';import { getHealerById } from '@/data/dashboard/healers';
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex -space-x-2">
                      {mockHealers.slice(0, 3).map((healer: ChatHealer) => (
                        <img
                          key={healer.id}
                          src={healer.avatar}
                          alt={healer.name}
