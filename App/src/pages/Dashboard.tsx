...
import { Bot as Lotus, Calendar, Smile, BookOpenText, Menu, MessageCircle, Users, Moon, Droplet, Sun, Camera } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useAuth } from '../contexts/AuthContext';
import { useNavigate } from 'react-router-dom';
import FirstTimeDashboard from './FirstTimeDashboard';
import DailySoothingNote from '../components/dashboard/DailySoothingNote';
import ProgramCard from '../components/dashboard/ProgramCard';
import HealingTeamBoard from '../components/dashboard/HealingTeamBoard';
import HealingTeamButtons from '../components/dashboard/HealingTeamButtons';
