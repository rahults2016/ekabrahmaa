...
import { Stethoscope, Brain, Utensils, Activity, Heart, Check, FileText, Video, ChevronDown, ChevronUp, Award, Calendar, MapPin, Languages, Plus, ArrowRight, Star, Users } from 'lucide-react';
